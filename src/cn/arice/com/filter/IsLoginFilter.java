...
public class IsLoginFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if("Signin".equals(action)||"404.jsp".equals(action)||"signin.jsp".equals(action)||"Image".equals(action)||action.endsWith("js")||action.endsWith("gif")||action.endsWith("css")||action.endsWith("png")||action.endsWith("jpg")||action.endsWith("ico")){
			//放行
